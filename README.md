...
```
 ...
 --lmbda_idx (lambda value determines l1-norm fraction to regularize loss (index to access lambda value in pre-defined range over k values); will be divided by number of items in the original data matrix)
...
```
python main.py --task odd_one_out --modality behavioral/ --triplets_dir ./triplets/behavioral/ --learning_rate 0.001 --lmbda 0.008 --embed_dim 90 --batch_size 100 --epochs 500 --window_size 20 --sampling_method soft --p 0.7 --plot_dims --device cuda:0 --rnd_seed 42
```
